...
for ($i = count($arrPages) - 1; $i >= 0; $i--) {
	...
	<li class="main-portfolio__item item-portfolio _parent-popup">
		<div class="item-portfolio__content content-item">
			<h2 class="content-item__title"><?= $arrPages[$i] ?></h2>
			<p class="content-item__about">
				<?= file_get_contents('pages /' . $arrPages[$i] . '/textPortfolio.txt'); ?>
			</p>
			<a href="pages/<?= $arrPages[$i] ?>/index.html" class="content-item__web">Перейти на сайт...</a>
		</div>
